...
import { getAdminLostPosts } from "../../api/admin.api.js"
...
export default function AdminLostPostsPage() {
    ...
    useEffect(() => {
        ...
        async function loadPosts() {
            ...
            try {
                const result = await getAdminLostPosts({
                    status
                })
                ...
                <div className="admin-list-toolbar">
                    ...
                    <div className="admin-search-box">
                        ...
                        <input
                            type="search"
                            value={keyword}
                            placeholder="이름, 품종, 지역, 게시글 ID 검색"
